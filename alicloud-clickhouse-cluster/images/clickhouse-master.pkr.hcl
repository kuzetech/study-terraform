...
variable "image_name" {
  type    = string
  default = "ubuntu_20_04_x64_20G_clickhouse_master_20211027"
}

source "alicloud-ecs" "ubuntu-clickhouse-master" {
...
build {
  sources = ["sources.alicloud-ecs.ubuntu-clickhouse-master"]
